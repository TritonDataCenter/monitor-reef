...
pub use types::{
    ...
    Instance, InstanceBrand, InstanceCreateResult, IpCidr, JobKind, JobOutcome, JobStatus,
    JobStatusKind, LegacyNic, LegacyVm, LifecycleState, LifecycleStateKind, ManagedIdentity,
