...
/// whenever it changes.
///
/// Unlike [`ZoneConfigWatcher`], sysinfo changes need richer handling: the
/// embedding service typically re-reads sysinfo and re-registers with the
/// control plane. So this watcher calls a custom callback instead of
/// marking the status flag.
