...
//!
//! ```text
//! triton-relay-bridge --relay-url ws://... --listen 127.0.0.1:50000 --target 10.x.x.x:50000
//! triton-relay-bridge --relay-url ws://... --listen 127.0.0.1:6443  --target 10.x.x.x:6443
//! ```
...
struct Args {
    ...
    /// Local address to listen on (e.g. 127.0.0.1:50000)
    #[arg(long)]
    listen: String,

    /// Fabric target to forward connections to (e.g. 10.0.0.5:50000)
    #[arg(long)]
    target: String,
}
