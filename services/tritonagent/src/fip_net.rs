...
/// `<link>/fip-<addr-with-dots-and-colons-flattened>`. ipadm address
/// object names allow alnum + `_`; we flatten `.`/`:` to `_`.
...
mod tests {
    ...
    #[test]
    fn addr_object_name_flattens_v4_and_v6() {
        let v4 = addr_object_name("external0", IpAddr::V4(Ipv4Addr::new(192, 0, 2, 10)));
        assert_eq!(v4, "external0/fip_192_0_2_10");
        let v6 = addr_object_name(
            "external0",
            IpAddr::V6(Ipv6Addr::new(0x2001, 0xdb8, 0, 0, 0, 0, 0, 1)),
        );
        assert_eq!(v6, "external0/fip_2001_db8__1");
    }
    ...
    fn delete_addr_args_reconstructs_object_name() {
        ...
        assert_eq!(args, vec!["delete-addr", "external0/fip_192_0_2_10"]);
    }
}
