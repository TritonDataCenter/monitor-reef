...
//! (monitor-reef-nbdp). Sibling of `tenant_storage_buckets.rs`.
//! Covers the gates the handler owns — authn/authz, cross-silo
//! defence, 412 on an unbound tenant, and upstream-error
//! pass-through against an unreachable mantad. Workspace-filter
//! correctness is mantad's responsibility.
